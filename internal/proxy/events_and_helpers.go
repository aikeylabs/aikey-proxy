...
func (p *Proxy) reportUsage(route *vkeys.ResolvedRoute, bearerToken, model string, startTime time.Time, statusCode int, breakdown provider.TokenBreakdown, errorType, errorMessage, realKey, sessionID, completion, upstreamReqID, requestPath, requestID, traceID string) {
