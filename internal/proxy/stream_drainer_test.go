...
func TestStreamDrainer_ForwardsFullStream(t *testing.T) {
	...
	drainer := newStreamDrainer(upstream, baseEvent, &provider.Anthropic{}, collector, context.Background(), context.Background())
...
func TestStreamDrainer_StopsOnClientDisconnect(t *testing.T) {
	...
	drainer := newStreamDrainer(upstreamPR, baseEvent, &provider.Anthropic{}, collector, context.Background(), context.Background())
...
func TestStreamDrainer_ProxyContextAbort(t *testing.T) {
	...
	drainer := newStreamDrainer(pr, baseEvent, &provider.Anthropic{}, collector, proxyCtx, context.Background())
